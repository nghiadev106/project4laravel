...
class UpdateRequest extends FormRequest
{
    ...
    {
        return [
            'name' => 'required|max:255|unique:tbl_product,name,'.request()->id,
            'slug' => 'required|max:255|unique:tbl_product,slug,'.request()->id,
    ...
    public function messages()
    {
        return [
            ...
            'product_status.required' => 'Mời bạn chon trạng thái',
